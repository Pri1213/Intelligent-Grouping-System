...
<head>
    ...
    <title>Admin Dash Lecturer</title>

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"/>
    <link rel="stylesheet" type="text/css" href="css/styleAdminDashLecturer.css">
...
<body>
    ...
    <div class="pageContainer">
        ...
        <div class="mainContent"> 
            ...
            <div class="box1">
            <?php
                   // display list of lecturer in a table
                   if (count($lecturer) > 0) {
                   ...
                   echo "<tr><td>" . $lecturer["EmailAddress"] . "</td><td>" . $lecturer["UserID"] . "</td><td>" . $lecturer["UserType"] . "</td><td>" . $lecturer["Status"] . "</td>" . "</td><td><a href ='adminLecturerEdit.php?id=" . $lecturer["UserID"] . "'>Edit</a></td></tr>";
                   }
                   echo "</tbody>";
                   echo "</table>";
                 } else {
