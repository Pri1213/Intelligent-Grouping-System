...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styleStudentDashboard copy.css">
...
<body>
    ...
    <div class="topContainer">  
        <!--This is the HTML for the line graph box-->
        

        <!--This is the HTML for the  SURVEY box-->
        <div class="containerForSurvey">
            <div class="box4">
        ...
        <!--This is the HTML for the RADAR box-->
        
    </div><br><br><br>


    <!--Recreate a REPONSIVE BOX here -->
        ...
        <div class="lastBoxContainer">
            <div class="lastBox">
                ...
                <div class="columns">
                    <div class="column">
                        <div class="row">
                           <p>Display line chart here</p>
                        </div><!-- end of row here -->
                    </div><!--end of column here -->

                    <div class="column">
                        <div class="row">
                            <P>Display radar here</P>
                        </div><!-- end of row here -->
                    </div><!--end of column here -->

                </div><!--End of columns here -->

            </div>
        </div>
    </div><!--End of third Container-->  

    <!--eND OF Recreation of box here-->




    <!--This is the container for all the personality traits-->
    <div class="container">
        <div class="title">Dimensions</div>
        <div class="box1">
            <div class="round-box motivation" onclick="window.location='https://challenge.curtin.edu.au/';">
                <img class="img"  src="images/reward.png" alt="Motivation">
                <div class="text">Motivation</div>
            </div>

            <div class="round-box personality" onclick="window.location='https://challenge.curtin.edu.au/';">
                <img class="img" src="images/personality.png" alt="Personality">   
                <div class="text">Personality</div>
            </div>

            <div class="round-box leadership" onclick="window.location='https://challenge.curtin.edu.au/';">
                <img class="img" src="images/leadership.png" alt="Leadership">
                <div class="text">Leadership Preferences</div>
            </div>

            <div class="round-box writing" onclick="window.location='https://challenge.curtin.edu.au/';">
                <img class="img" src="images/writing.png" alt="Writing Skills">  
                <div class="text">Writing Skills</div>
            </div>

            <div class="round-box software" onclick="window.location='https://challenge.curtin.edu.au/';">
                <img class="img" src="images/software.png" alt="Software Skills">
                <div class="text">Software Skills</div>
            </div>

            <div class="round-box planning" onclick="window.location='https://challenge.curtin.edu.au/';">
                <img class="img" src="images/planning.png" alt="Planning Skills">
                <div class="text">Organisation and Planning Skills</div>
            </div>

            <div class="round-box numeracy" onclick="window.location='https://challenge.curtin.edu.au/';">
                <img class="img" src="images/number.png" alt="Numeracy Skills">
                <div class="text">Numeracy Skills</div>
            </div>

            <div class="round-box research" onclick="window.location='https://challenge.curtin.edu.au/';">
            ...
            <div class="round-box creativity" onclick="window.location='https://challenge.curtin.edu.au/';">
